...
/**
 * BeanInfo for an HistoGraph.
 *
 * @version 1.1
 */
public class HistoGraphBeanInfo extends SimpleBeanInfo
{
  public HistoGraphBeanInfo()
  {
  }
  ...
  public java.awt.Image getIcon (int iconKind)
  {
    if (iconKind == BeanInfo.ICON_MONO_16x16 || iconKind == BeanInfo.ICON_COLOR_16x16) {
      java.awt.Image i = loadImage ("beaninfo/HistoGraph_16.gif");
      return i;
    }
